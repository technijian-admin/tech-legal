...
def build_msa():
    ...
    d.footer_bar()
    d.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "02_MSA", "MSA-AAVA.docx"))
...
def build_schedule_a():
    ...
    d.footer_bar()
    d.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "02_MSA", "Schedule-A-AAVA.docx"))
...
def build_schedule_b():
    ...
    d.footer_bar()
    d.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "02_MSA", "Schedule-B-AAVA.docx"))
...
def build_schedule_c():
    ...
    d.footer_bar()
    d.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "02_MSA", "Schedule-C-AAVA.docx"))
...
def build_executive_summary():
    ...
    d.footer_bar()
    d.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "02_MSA", "AAVA-Executive-Summary.docx"))
