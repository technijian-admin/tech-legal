"""
Culp Construction Company (CCC) MSA DOCX Generator
Home computer support — 1 desktop, 1 user, 1 M365 mailbox
...
def build_msa():
    d = BrandedDoc()
    d.cover_page("Master Service Agreement", "Home Computer Support & Email Services")
    d.page_break()

    d.part_header("MASTER SERVICE AGREEMENT")
    d.spacer()
    d.body("Agreement Number: MSA-CCC-2026")
    ...
    d.body("247 Mimulus")
    d.body("Rancho Santa Fe, California 92067")
    d.body("Website: culpco.com")
    d.spacer()
    ...
    d.spacer()
    d.body("Attached to Master Service Agreement MSA-CCC-2026")
    d.body("Effective Date: May 1, 2026")
    d.spacer()
