"""One-off: patch + convert ONLY the revised Yogesh retrenchment DOCX to PDF.

Mirrors _convert-rajat-only.py. Run AFTER:
    ONLY=yogesh node generate-letters-docx.js
"""
...
NAME = "05-Yogesh-Kumar-Retrenchment.docx"
