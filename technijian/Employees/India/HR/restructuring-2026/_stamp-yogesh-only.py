"""One-off: stamp Ravi's signature on ONLY the revised Yogesh retrenchment PDF.

Mirrors _stamp-rajat-only.py. Reuses letters/pdf/_signature_debug.png produced
by the original stamp-signatures.py run on 2026-05-11.
"""
import io
...
NAME = "05-Yogesh-Kumar-Retrenchment.pdf"
