...
This Schedule describes the Subscription and License Services provided by Technijian, Inc. ("Technijian") to [CLIENT NAME] ("Client") under the Master Service Agreement.
...
| Specialty | FoxIT PDF, Adobe Creative Cloud, other line-of-business applications |
...
**4.01. Subscription Fees.** Client shall pay the fees for Subscription Services as set forth in the **Subscription Order** attached to this Schedule. Fees include Technijian's management and procurement services.
