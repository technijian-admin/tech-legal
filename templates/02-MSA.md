...
WHEREAS, Client desires to engage Technijian to provide certain services as described in the Schedules attached hereto;
...
- **Schedule A** — Monthly Managed Services (Online Services, SIP Trunk, Virtual Staff)
- **Schedule B** — Subscription and License Services
- **Schedule C** — Rate Card
- **Schedule D** — Data Processing Addendum (executed if Technijian Processes Personal Information on Client's behalf, or if Client is subject to HIPAA, GDPR, or other industry-specific data protection requirements)
...
**9.01. Entire Agreement.** This Agreement, together with its Schedules and any SOWs, constitutes the entire agreement between the Parties and supersedes all prior agreements, whether written or oral, relating to the subject matter hereof.

**9.02. Amendment.** This Agreement may only be amended by a written instrument signed by both Parties. Technijian may update its Rate Card (Schedule C) upon **sixty (60) days** written notice to Client, effective at the start of the next Renewal Term.
...
**9.07. Notices.** All notices shall be in writing and delivered by email with confirmation, certified mail, or nationally recognized overnight courier to the addresses set forth above (or as updated in writing).
...
If Technijian Processes Personal Information on Client's behalf, the Parties shall execute **Schedule D — Data Processing Addendum** (the "DPA"), which provides the specific business purposes per data category, retention periods, Subprocessor disclosures (including offshore personnel), security measures, audit rights, and where applicable HIPAA Business Associate terms (Annex 1) and GDPR / Standard Contractual Clauses (Annex 2). In the event of a conflict between this Section 10 and Schedule D on matters of personal-data processing, Schedule D prevails.
...
- Schedule B — Subscription and License Services
- Schedule C — Rate Card
- Schedule D — Data Processing Addendum (if executed)
