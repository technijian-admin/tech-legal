...
**SOW Number:** [SOW-XXXX]
**Effective Date:** [DATE]
**Master Service Agreement:** [MSA-XXXX] (if applicable)
...
[Brief description of the project, including the business need and desired outcome.]

### 1.3 Locations

| Location Name | Code | Address | Billable |
|---------------|------|---------|----------|
| [Location 1] | [CODE] | [ADDRESS] | Yes/No |
...
[Describe what is included in this SOW.]
...
[Description of the phase objectives and activities.]
...
|------|-------------|------------|----------|----------|
| [Role] | [Task description] | [Hours] | [Day/Week] | [TBD/Named] |
| | **Total** | **[Hours]** | | |
...
*Complete this section if the SOW includes hardware or equipment procurement.*

| Item | Description | Qty | Unit Price | Tax | Sub-Total |
|------|-------------|-----|-----------|-----|-----------|
| [Item] | [Description/specs] | [Qty] | $[___] | [Y/N] | $[___] |
| | | | **Sub-Total:** | | $[___] |
| | | | **Sales Tax ([_]%):** | | $[___] |
| | | | **Equipment Total:** | | $[___] |
...
Title to equipment shall remain vested in Technijian until paid for in full. Upon receipt of full payment, title shall transfer to Client.
...
If Client elects to finance equipment through a third-party financing provider, Technijian's obligation is fulfilled upon receipt of payment from the financing provider. Client's financing obligations are between Client and the financing provider.
...
|-------|------|------------|------|
| [Phase 1] | [Fixed/Estimate] | [Hours] | $[___] |
| [Phase 2] | [Fixed/Estimate] | [Hours] | $[___] |
| Equipment | | | $[___] |
| **Total** | | | **$[___]** |

**Pricing Type Definitions:**

- **Fixed Cost:** Technijian will complete the work at the stated price regardless of actual hours.
- **Estimate Cost:** The stated hours and cost are estimates. Technijian will bill for actual time at the applicable rate. If actual hours are projected to exceed the estimate by more than 10%, Technijian will notify Client before proceeding.

### 5.2 Payment Schedule

| Milestone | Invoiced | Amount |
|-----------|----------|--------|
| [e.g., Before Phase 1 begins] | [Timing] | $[___] |
| [e.g., After Phase 2 completion] | [Timing] | $[___] |
| [e.g., Equipment delivery] | [Timing] | $[___] |
| **Total** | | **$[___]** |
...
(a) Provide access to systems, facilities, and personnel as reasonably required;
